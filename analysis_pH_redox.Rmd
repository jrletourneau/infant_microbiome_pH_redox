...
pH_redox %>%
  mutate(postnatalabx = factor(postnatalabx, levels = c("None", "48 hr", ">5 d"))) %>%
  lmer(redox ~ bw + postnatalabx + (1 | Subject), data  = .) %>%
  summary()

# pH
# bw               -0.0008606  0.0003174 73.0000000  -2.711  0.00835 ** 
# postnatalabx48hr  0.7136952  0.1529320 73.0000000   4.667 1.35e-05 ***
# postnatalabx>5d   1.0187043  0.1962401 73.0000000   5.191 1.81e-06 ***

# redox
# bw                  0.3011     0.1393    7.9483   2.161   0.0629 .
# postnatalabx48hr  120.3983    72.7298    6.1631   1.655   0.1476  
# postnatalabx>5d   140.5083    93.4952    5.6541   1.503   0.1865  
